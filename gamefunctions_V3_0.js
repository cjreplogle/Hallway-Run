...
function SpriteSheet (x,y,width,height, useWidth, useHeight, dir, frame, sheet) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
        ...
        this.draw = function() {
            if (this.visible) {
                ...
                ctx.drawImage(this.sheet,this.currentFrame * this.width,this.currentDir * this.height,this.width,this.height,this.x,this.y,this.useWidth,this.useHeight);
...
function BottomCollision (obj1, obj2) {
    if(obj1.x + obj1.useWidth-10 > obj2.x && obj1.x < obj2.x + obj2.useWidth-10) {
        if (obj1.y  < obj2.y + obj2.useHeight-10 && obj1.y + obj1.useHeight-10 + 1 > obj2.y ){
            obj1.collision = true;
            //obj1.stopJump();
            return true;
        }
...
function TopCollision (obj1, obj2) {
    if(obj1.x + obj1.useWidth-10 > obj2.x && obj1.x < obj2.x + obj2.useWidth-10) {
        if (obj1.y  - 1 < obj2.y + obj2.useHeight-10 && obj1.y  > obj2.y ){
            obj1.collision = true;
            //obj1.stopJump();
            return true;
        }
...
function RightCollision (obj1, obj2) {
    ...
    if(obj1.y + obj1.useHeight-10 > obj2.y && obj1.y < obj2.y + obj2.useHeight-10) {
        if (obj1.x + obj1.useWidth-10 + 1  > obj2.x && obj1.x < obj2.x + obj2.useWidth-10){
            obj1.collision = true;
            //obj1.stopJump();
            return true;
        }
...
function LeftCollision(obj1, obj2) {
    obj1.collision = false;
    if(obj1.y + obj1.useHeight-10 > obj2.y && obj1.y < obj2.y + obj2.useHeight-10) {
        if (obj1.x + obj1.useWidth-10   > obj2.x && obj1.x -1 < obj2.x + obj2.useWidth-10){
            obj1.collision = true;
            //obj1.stopJump();
            return true;
        }
