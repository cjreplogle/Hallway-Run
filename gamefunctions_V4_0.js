...
function Sprite (x,y,width,height, useWidth, useHeight,image) {
        ...
        this.checkCollisions = function(obj2) {
            var bot = BottomCollision(this, obj2);
            var top = TopCollision(this,obj2);
            var left = LeftCollision(this,obj2);
            var right = RightCollision(this,obj2);
...
function TopCollision (obj1, obj2) {
    if(obj1.x + obj1.useWidth-10 > obj2.x && obj1.x < obj2.x + obj2.useWidth-10) {
        if (obj1.y  - 10 < obj2.y + obj2.useHeight-10 && obj1.y  > obj2.y ){
            obj1.collision = true;
            //obj1.stopJump();
            return true;
        }
